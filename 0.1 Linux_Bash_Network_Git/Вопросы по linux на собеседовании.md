...
***
### Какие системы инициализации используются в современных дистрибутивах? (init)
...
И то, и то система инициализации.
...
***
### Как работает OOM (Out of memory) Killer и для чего нужен? 
